      ...
      <div class="modal-body table-responsive">
        <table class="table table-striped" style="font-size: small;" id="tabel2">
          ...
          foreach ($dt_tindakan->result() as $data){
                ...
                <td>'.$data->harga.'</td>
                <td>
                        <button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Pilih Data Ini" onClick="simpanform.obat_tindakan.value = \''.$data->nm_tindakan.'\'; simpanform.harga.value = \''.$data->harga.'\'" data-dismiss="modal">
