...
<div class="col-md-6">
  ...
  <div class="col-md-4">
    <br>
    <div class="form-group row">
      <label for="obat_tindakan" class="col-md-3 col-sm-2 col-form-label">Obat</label>
      <div class="col-md-9 col-sm-10">
        <input type="text" class="form-control" id="obat" name="obat" placeholder="Obat" required readonly>
      </div>
    </div>
    ...
    <table class="table table-striped">
      ...
      foreach ($dt_detail->result() as $data){
            ...
            <td>Rp. '.$data->subtotal.'</td>
                <td>
                    <a class="btn btn-outline-dark btn-sm" href="delete_obat/'.md5($data->obat).'" role="button" data-toggle="tooltip" data-placement="top" title="Hapus">
