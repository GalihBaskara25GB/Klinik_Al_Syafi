      ...
      <div class="modal-body table-responsive">
        <table class="table table-striped" style="font-size: small;" id="tabel2">
          ...
          foreach ($dt_obat->result() as $data){
                ...
                <td>
                        <button type="button" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="Pilih Data Ini" onClick="simpanform.obat.value = \''.$data->nm_obat.'\'; simpanform.jumlah.max = \''.$data->stok.'\'; simpanform.harga.value = \''.$data->harga_jual.'\'" data-dismiss="modal">
